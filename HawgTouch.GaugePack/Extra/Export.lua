-- HawgTouch Data Export script - 1.6
...
function UpdateFuelGauge(mainPanelDevice)
	SendData(2000, string.format("%0.2f;%0.2f;%0.5f;%0.4f;%0.4f", mainPanelDevice:get_argument_value(90), mainPanelDevice:get_argument_value(91), mainPanelDevice:get_argument_value(92),mainPanelDevice:get_argument_value(88),mainPanelDevice:get_argument_value(89)))
end

function UpdateHSI(mainPanelDevice)
	SendData(2001, string.format("%0.4f;%0.4f;%0.4f;%0.4f;%0.4f;%0.4f;%0.2f;%0.2f;%0.2f;%0.4f;%0.4f", 	mainPanelDevice:get_argument_value(34), mainPanelDevice:get_argument_value(33), mainPanelDevice:get_argument_value(35),mainPanelDevice:get_argument_value(36),mainPanelDevice:get_argument_value(47),mainPanelDevice:get_argument_value(41),mainPanelDevice:get_argument_value(29),mainPanelDevice:get_argument_value(30),mainPanelDevice:get_argument_value(31),mainPanelDevice:get_argument_value(42),mainPanelDevice:get_argument_value(43)))
end

function UpdateAltimeter(mainPanelDevice)
	SendData(2002, string.format("%0.4f;%0.2f;%0.2f;%0.5f", mainPanelDevice:get_argument_value(51), mainPanelDevice:get_argument_value(52), mainPanelDevice:get_argument_value(53),mainPanelDevice:get_argument_value(54)))
end

function UpdateADI(mainPanelDevice)
	SendData(2003, string.format("%0.4f;%0.4f;%0.4f;%0.4f", mainPanelDevice:get_argument_value(17), mainPanelDevice:get_argument_value(18), mainPanelDevice:get_argument_value(24), mainPanelDevice:get_argument_value(20)))
end

function UpdateTACAN(mainPanelDevice)
	SendData(2004, string.format("%0.1f;%0.1f;%0.1f;%0.1f", mainPanelDevice:get_argument_value(263), mainPanelDevice:get_argument_value(264), mainPanelDevice:get_argument_value(265), mainPanelDevice:get_argument_value(266)))
end

function UpdateILS(mainPanelDevice)
	SendData(2005, string.format("%0.1f;%0.1f;%0.1f;%0.1f;%0.1f", mainPanelDevice:get_argument_value(251), mainPanelDevice:get_argument_value(252), mainPanelDevice:get_argument_value(253), mainPanelDevice:get_argument_value(254), mainPanelDevice:get_argument_value(255)))
end
...
function UpdateUH1GasProducerTach(mainPanelDevice)
	SendData(3001, string.format("%0.4f;%0.4f", mainPanelDevice:get_argument_value(119), mainPanelDevice:get_argument_value(120)))
end

function UpdateUH1DualTach(mainPanelDevice)
...
-- Works once just before mission start.
    ...
    c = socket.udp()
	c:setsockname("*", 0)
    c:setpeername(localAddress, port)
    c:settimeout(.001)
end
...
function SetExportData()
	...
	if gCurrentAircraft == "A-10C" then
    	ImportedData = ImportedA10Data
    elseif gCurrentAircraft == "UH-1H" then
    	ImportedData = ImportedUH1Data
    elseif gCurrentAircraft == "P-51D" then
    	ImportedData = ImportedP51Data
    end
end
